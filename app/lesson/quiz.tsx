...
const Quiz = ({
    ...
    const [finishAudio]=useAudio({src:"/clapping.mp3",autoPlay:true});
    ...
    const options = challenge?.challengeOptions ?? []; //??を挟んで左の値がnullまたはundefinedのとき、右の値を返す。それ以外の場合に左の値を返す。
        ...
        return (
            <>
             ...
             <div className="flex flex-col gap-y-4 lg:gap-y-8 max-w-lg mx-auto text-center items-center justify-center h-full">
                 <Image src={"/celebration.jpg"} alt={"finish"}
                        className={"hidden lg:block"} height={100} width={100} />
                 <Image src={"/celebration.jpg"} alt={"finish"}
                        className={"block lg:hidden"} height={50} width={50} />
